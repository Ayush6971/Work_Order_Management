    ...
    var n = {
      ...
      s = {
        ...
        _hide: function (n) {
          ...
          if (!n) {
            ...
            setTimeout(
              ...
              typeof t.delay != "number" || t.delay == "auto"
                ? u < 2500
                  ? 2500
                  : u
                : t.delay
        ...
        _setContent: function () {
          ...
          if (
            e.inArray(t.type, ["success", "error", "warning", "info"]) != -1
          ) {
            r.addClass(t.type);
          }
          ...
          if (t.size && t.size != null && t.size != "normal") {
            if (
              t.size == "full" &&
              (t.position.y == "top" || t.position.y == "bottom")
            ) {
          ...
          if (t.icon && t.icon != null) {
            var n = e(t.icon).is("img")
              ? e(t.icon)
              : e(t.icon).find("img").length != 0
              ? e(t.icon).find("img")
              : e(t.icon);
            r.prepend(
              '<div class="notify-icon"><div class="notify-icon-inner">' +
                t.icon +
                "</div>"
            );
          } else {
            ...
            if (e("body").find(t._classes.overlay).length == 0) {
              e(
                '<div class="notify-overlay' +
                  (typeof t.overlay == "string" ? " " + t.overlay : "") +
                  '"></div>'
              )
                .hide()
                .appendTo("body")
